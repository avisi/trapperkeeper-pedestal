(ns nl.avisi.trapperkeeper-pedestal.example-web-service-test
  (:require [clojure.test :refer :all]
            ...
            [nl.avisi.trapperkeeper-pedestal.example-service :as svc]
            [nl.avisi.trapperkeeper-pedestal.example-web-service :as web-svc]))
